...
class BodyListVahicleInParkRoleUser extends StatefulWidget {
  final String? loaixe;
  BodyListVahicleInParkRoleUser({Key? key, this.loaixe}) : super(key: key);

  @override
  _BodyListVahicleInParkRoleUserState createState() =>
      _BodyListVahicleInParkRoleUserState();
}

class _BodyListVahicleInParkRoleUserState
    extends State<BodyListVahicleInParkRoleUser> {
  @override
  ...
  void getProductLoai5() {
    BlocProvider.of<ListVahicleInParkBloc>(context).add(
        (ListVahicleInParkEventE(
