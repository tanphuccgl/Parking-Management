...
class BodyCarList extends StatefulWidget {
  final String? loaixe;
  BodyCarList({Key? key, this.loaixe}) : super(key: key);

  @override
  _BodyCarListState createState() => _BodyCarListState();
}

class _BodyCarListState extends State<BodyCarList> {
  @override
  ...
  void getProductLoai5() {
    BlocProvider.of<VahicleListBloc>(context)
        .add((VahicleListEventE(loaixe: widget.loaixe, name: "")));
  }
