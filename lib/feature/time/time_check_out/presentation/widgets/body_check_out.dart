...
class BodyCheckOutHistory extends StatefulWidget {
  BodyCheckOutHistory({Key? key}) : super(key: key);

  @override
  _BodyCheckOutHistoryState createState() => _BodyCheckOutHistoryState();
}

class _BodyCheckOutHistoryState extends State<BodyCheckOutHistory> {
  @override
  Widget build(BuildContext context) {
    Size size = MediaQuery.of(context).size;
    return BlocBuilder<TimeCheckOutBloc, TimeCheckOutState>(
      builder: (context, state) {
        if (state is Empty) {
          BlocProvider.of<TimeCheckOutBloc>(context)
              .add((TimeCheckOutEventE()));
